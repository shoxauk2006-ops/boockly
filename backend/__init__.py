# Load the standalone Skedwoo account/auth routes alongside the API app.
...
# Staff/specialist Telegram access and workspace routes.
from . import staff_routes  # noqa: F401,E402
