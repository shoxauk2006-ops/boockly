(function () {
  ...
  async function mountWorkspace(html) {
    ...
    // Keep the original loader mounted while the account application starts.
    // This prevents a blank frame followed by the second loader embedded in
    // account-core.html. The fallback preserves support for older browsers.
