...
const EXTRA: Record<string,Row> = {
  ...
  'После этого Skedwoo будет готов к работе внутри админки.': {ru:'После этого Skedwoo будет готов к работе внутри админки.',en:'After that, Skedwoo will be ready to use in the admin panel.',uz:'Shundan so‘ng Skedwoo admin panelda ishlashga tayyor bo‘ladi.',tr:'Bundan sonra Skedwoo yönetim panelinde kullanıma hazır olur.',ar:'بعد ذلك سيكون Skedwoo جاهزًا للاستخدام داخل لوحة الإدارة.'},
  ...
  'только после активации Skedwoo Pro.': {ru:'только после активации Skedwoo Pro.',en:'only after Skedwoo Pro is activated.',uz:'faqat Skedwoo Pro faollashtirilgandan keyin.',tr:'yalnızca Skedwoo Pro etkinleştirildikten sonra.',ar:'فقط بعد تفعيل Skedwoo Pro.'},
  ...
  'Skedwoo Pro нужен для клиентского доступа.': {ru:'Skedwoo Pro нужен для клиентского доступа.',en:'Skedwoo Pro is required for client access.',uz:'Mijozlar uchun kirish Skedwoo Pro talab qiladi.',tr:'Müşteri erişimi için Skedwoo Pro gereklidir.',ar:'يلزم Skedwoo Pro للوصول للعملاء.'},
  ...
  'Активировать Skedwoo Pro': {ru:'Активировать Skedwoo Pro',en:'Activate Skedwoo Pro',uz:'Skedwoo Pro’ni faollashtirish',tr:'Skedwoo Pro’yu etkinleştir',ar:'تفعيل Skedwoo Pro'},
  ...
  'Skedwoo QR-код': {ru:'Skedwoo QR-код',en:'Skedwoo QR code',uz:'Skedwoo QR-kodi',tr:'Skedwoo QR kodu',ar:'رمز QR لـ Skedwoo'},
