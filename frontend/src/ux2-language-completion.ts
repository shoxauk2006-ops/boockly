...
const EXTRA: Record<string,Row> = {
  ...
  'После этого Skedvo будет готов к работе внутри админки.': {ru:'После этого Skedvo будет готов к работе внутри админки.',en:'After that, Skedvo will be ready to use in the admin panel.',uz:'Shundan so‘ng Skedvo admin panelda ishlashga tayyor bo‘ladi.',tr:'Bundan sonra Skedvo yönetim panelinde kullanıma hazır olur.',ar:'بعد ذلك سيكون Skedvo جاهزًا للاستخدام داخل لوحة الإدارة.'},
  ...
  'только после активации Skedvo Pro.': {ru:'только после активации Skedvo Pro.',en:'only after Skedvo Pro is activated.',uz:'faqat Skedvo Pro faollashtirilgandan keyin.',tr:'yalnızca Skedvo Pro etkinleştirildikten sonra.',ar:'فقط بعد تفعيل Skedvo Pro.'},
  ...
  'Skedvo Pro нужен для клиентского доступа.': {ru:'Skedvo Pro нужен для клиентского доступа.',en:'Skedvo Pro is required for client access.',uz:'Mijozlar uchun kirish Skedvo Pro talab qiladi.',tr:'Müşteri erişimi için Skedvo Pro gereklidir.',ar:'يلزم Skedvo Pro للوصول للعملاء.'},
  ...
  'Активировать Skedvo Pro': {ru:'Активировать Skedvo Pro',en:'Activate Skedvo Pro',uz:'Skedvo Pro’ni faollashtirish',tr:'Skedvo Pro’yu etkinleştir',ar:'تفعيل Skedvo Pro'},
  ...
  'Skedvo QR-код': {ru:'Skedvo QR-код',en:'Skedvo QR code',uz:'Skedvo QR-kodi',tr:'Skedvo QR kodu',ar:'رمز QR لـ Skedvo'},
