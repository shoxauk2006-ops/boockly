...
const T: Record<string, TextSet> = {
  ...
  'Skedwoo помогает бизнесу принимать записи прямо в Telegram.': {ru:'Skedwoo помогает бизнесу принимать записи прямо в Telegram.',en:'Skedwoo helps businesses accept appointments directly in Telegram.',uz:'Skedwoo bizneslarga Telegram ichida to‘g‘ridan-to‘g‘ri bron qabul qilishga yordam beradi.',tr:'Skedwoo işletmelerin doğrudan Telegram üzerinden randevu almasını sağlar.',ar:'يساعد Skedwoo الأنشطة التجارية على استقبال الحجوزات مباشرةً داخل تيليجرام.'},
  ...
  'Skedwoo Pro': {ru:'Skedwoo Pro',en:'Skedwoo Pro',uz:'Skedwoo Pro',tr:'Skedwoo Pro',ar:'Skedwoo Pro'},
};
