...
const en: TranslationMap = {
  ...
  'home.title': 'Booking without calls','home.description': 'Bookly helps businesses accept bookings directly in Telegram.','home.openAdmin': 'Open admin panel','home.openBusiness': 'Open business page','home.slugPlaceholder': 'Business link or slug','home.emptySaved': 'Saved businesses will appear here.',
...
const uz: TranslationMap = {
  ...
  'home.title': 'Qo‘ng‘iroqlarsiz bron','home.description': 'Bookly bizneslarga Telegram ichida to‘g‘ridan-to‘g‘ri bron qabul qilishga yordam beradi.','home.openAdmin': 'Admin panelni ochish','home.openBusiness': 'Biznes sahifasini ochish','home.slugPlaceholder': 'Biznes havolasi yoki slug','home.emptySaved': 'Saqlagan bizneslaringiz shu yerda ko‘rinadi.',
...
const tr: TranslationMap = {
  ...
  'home.title': 'Arama olmadan rezervasyon','home.description': 'Bookly, işletmelerin Telegram içinde doğrudan rezervasyon almasına yardımcı olur.','home.openAdmin': 'Yönetim panelini aç','home.openBusiness': 'İşletme sayfasını aç','home.slugPlaceholder': 'İşletme bağlantısı veya slug','home.emptySaved': 'Kaydettiğiniz işletmeler burada görünecek.',
...
const ar: TranslationMap = {
  ...
  'home.title': 'حجز بدون مكالمات','home.description': 'يساعد Bookly الأنشطة التجارية على استقبال الحجوزات مباشرة داخل Telegram.','home.openAdmin': 'فتح لوحة الإدارة','home.openBusiness': 'فتح صفحة النشاط','home.slugPlaceholder': 'رابط النشاط أو slug','home.emptySaved': 'ستظهر هنا الأنشطة التي تحفظها.',
