...
help: {
  ...
  subtitle: "Пошаговая инструкция для владельца бизнеса",
  step1_title: "1. Создать бизнес",
  step1_desc: "Укажите название, описание, адрес, фото, геолокацию и часовой пояс.",
  step2_title: "2. Добавить информацию и фото",
  step2_desc: "Загрузите логотип и обложку, добавьте контакты, чтобы страница выглядела привлекательно.",
  step3_title: "3. Добавить услуги и цены",
  step3_desc: "Укажите названия услуг, их длительность и стоимость для клиентов.",
  step4_title: "4. Настроить график",
  step4_desc: "Задайте рабочие дни и часы приема для себя и ваших сотрудников.",
  step5_title: "5. Создать блокировки при необходимости",
  step5_desc: "Вносите перерывы, обеды и личные дела, чтобы клиенты не могли записаться на это время.",
  step6_title: "6. Управлять записями",
  step6_desc: "Отслеживайте новые входящие записи, подтверждайте или отменяйте их в админ-панели.",
  step7_title: "7. Активировать Bookly Pro",
  step7_desc: "Для полноценного начала приема онлайн-записей от клиентов активируйте подписку Bookly Pro через Paddle.",
  close: "Понятно"
},
