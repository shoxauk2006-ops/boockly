...
'common.copy': 'Скопировать',
  ...
  'owner.paymentFailedGeneric': 'Не удалось выполнить оплату.',
'owner.paymentDeclined': 'Платёж отклонён.',
'owner.insufficientFunds': 'Недостаточно средств на карте.',
'owner.cardExpired': 'Срок действия карты истёк.',
'owner.paymentAuthenticationFailed': 'Не удалось пройти проверку платежа.',
'owner.cardBlocked': 'Эта карта заблокирована или недоступна для оплаты.',
'owner.paymentDeclinedNoRetry': 'Банк отклонил платёж, и повторная попытка невозможна.',
  'owner.booklyProMonthly': 'Bookly Pro — $7.99 / месяц',
'owner.packageUpToServices': 'Пакет до',
'owner.services': 'услуг',
'owner.perMonth': '/ месяц',
...
'common.copy': 'Copy',
  ...
  'owner.paymentFailedGeneric': 'Payment could not be completed.',
'owner.paymentDeclined': 'Payment was declined.',
'owner.insufficientFunds': 'Insufficient funds on the card.',
'owner.cardExpired': 'The card has expired.',
'owner.paymentAuthenticationFailed': 'Payment authentication failed.',
'owner.cardBlocked': 'This card is blocked or unavailable for payment.',
'owner.paymentDeclinedNoRetry': 'The bank declined the payment and another attempt is not possible.',
  'owner.booklyProMonthly': 'Bookly Pro — $7.99 / month',
'owner.packageUpToServices': 'Package up to',
...
'owner.paymentAuthenticationFailed': 'To‘lovni tasdiqlashdan o‘tib bo‘lmadi.',
...
'owner.packageUpToServices': 'Paket',
'owner.services': 'ta xizmat',
'owner.perMonth': '/ oy',
...
'owner.insufficientFunds': 'Kartada yeterli bakiye yok.',
'owner.cardExpired': 'Kartanın süresi dolmuş.',
'owner.paymentAuthenticationFailed': 'Ödeme doğrulaması başarısız oldu.',
'owner.cardBlocked': 'Bu kart bloke edilmiş veya ödeme için kullanılamıyor.',
'owner.paymentDeclinedNoRetry': 'Banka ödemeyi reddetti ve tekrar deneme mümkün değil.',
  'owner.booklyProMonthly': 'Bookly Pro — $7.99 / ay',
'owner.packageUpToServices': 'Paket',
'owner.services': 'hizmete kadar',
'owner.perMonth': '/ ay',
...
'common.copy': 'نسخ',
  ...
  'owner.paymentFailedGeneric': 'تعذر إتمام الدفع.',
...
'owner.paymentAuthenticationFailed': 'تعذر التحقق من الدفع.',
'owner.cardBlocked': 'هذه البطاقة محظورة أو غير متاحة للدفع.',
'owner.paymentDeclinedNoRetry': 'رفض البنك عملية الدفع ولا يمكن إعادة المحاولة.',
  'owner.booklyProMonthly': 'Bookly Pro — $7.99 شهريًا',
'owner.packageUpToServices': 'باقة تصل إلى',
'owner.services': 'خدمات',
'owner.perMonth': '/ شهريًا',
