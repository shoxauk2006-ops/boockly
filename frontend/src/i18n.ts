...
const en: TranslationMap = {
  ...
  'home.title': 'Booking without calls','home.description': 'Bookly helps businesses accept bookings directly in Telegram.','home.openAdmin': 'Open admin panel','home.openBusiness': 'Open business page','home.slugPlaceholder': 'Business link or slug','home.emptySaved':'home.greeting': 'Welcome back',
'home.manageBusiness': 'Manage your business with Bookly',
'home.createBusinessHint': 'Create your business on Bookly', 'Saved businesses will appear here.',
...
const uz: TranslationMap = {
  ...
  'home.title': 'Qo‘ng‘iroqlarsiz bron','home.description': 'Bookly bizneslarga Telegram ichida to‘g‘ridan-to‘g‘ri bron qabul qilishga yordam beradi.','home.openAdmin': 'Admin panelni ochish','home.openBusiness': 'Biznes sahifasini ochish','home.slugPlaceholder':'home.greeting': 'Qaytganingizdan xursandmiz',
'home.manageBusiness': 'Bookly’da biznesingizni boshqaring',
'home.createBusinessHint': 'Bookly’da biznesingizni yarating', 'Biznes havolasi yoki slug','home.emptySaved': 'Saqlagan bizneslaringiz shu yerda ko‘rinadi.',
